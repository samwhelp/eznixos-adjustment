...
base_var_init () {
	...
	THE_MASTER_PART_DIR_NAME="part"
	THE_MASTER_PART_DIR_PATH="${THE_MASTER_DIR_PATH}/${THE_MASTER_PART_DIR_NAME}"

	THE_MASTER_VENDOR_DIR_NAME="vendor"
	THE_MASTER_VENDOR_DIR_PATH="${THE_MASTER_DIR_PATH}/${THE_MASTER_VENDOR_DIR_NAME}"
